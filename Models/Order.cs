...
namespace DemoStore.Models
{
    public class Order
    {
        ...
        [Required(ErrorMessage = "Пожалюйста введите имя")]
        ...
        [Required(ErrorMessage = "Пожалуйста ввеедите  номер телефона")]
        [StringLength(25)]
        ...
        [BindNever] [ScaffoldColumn(false)] public decimal OrderTotal { get; set; }
